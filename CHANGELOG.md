...
- Modify uploaded packaging file size from 4GB to 5GB (#1042) 
- Update CheckOSSName Button UI as disabled in DEP tab because it cannot be used in DEP tab (#1042)
- * Add 'sheetNames' parameter in oss report upload APIs (#1042 )
...
- Admin check is fixed. Even if there is a warning message (excluding unconfirmed license), confirmation will proceed if admin check is checked (#1042)
- Apply DEPENDENCIE and REF_OSS_NAME in mapper for component copy (#1042)
- Change DEPENDENCIES Column data type as text in DB (#1042)
- Project list was modified to check the open source vulnerability score in DEP tab (#1042)
- Bug fix where loading open source from 3rd party SW has an error when license name has 'and', 'or' keyword (#1042)
- Bug fix where a watcher with a changed division was not deleted from the project watcher list (#1042)
- Bug fix where notice appended contents was not visible in the confirmed project (#1042)
- Bug fix where list export result was different from the actual search result (#1042)
- Bug fix where not show vulnerability list when clicking on the security vulnerability icon in the Identification tab (#1042)
- Data sorting logic is fixed in OSS Table (#1042)
- Add highcharts.js as source code for Statistics (#1042)
- Bug fix where open source delete and merge is failed because of out of memory error (#1042)
- Bug fix where detected license information was not applied (#1042)
- Bug fix where SPDX export failed because 'exclude' data was included (#1042)
- Bug fix where CycloneDX file is not generated due to empty dependency info (#1042)

...
INSERT INTO `T2_CODE_DTL` (`CD_NO`, `CD_DTL_NO`, `CD_DTL_NM`, `CD_SUB_NO`, `CD_DTL_EXP`, `CD_ORDER`, `USE_YN`) VALUES
       ...
       ('102', '844', '[FOSSLight][3rd-${3rd ID}] : Action Required for Inactive 3rd : "${3rd Name}"', '', '', 844, 'Y'),
       ...
       ('103', '844', 'Notice Inactive 3rd', '', '205', 844, 'Y'),
       ...
       ('111', '844', 'Notice inactive 3rd', '', '<p>현재 해당 3rd는 최근 6개월 동안 업데이트 내역이 없습니다. 3rd의 지속적인 관리와 효율적인 자원 활용을 위해 아래와 같이 조치를 요청드립니다.</p><br> <strong>3rd 업데이트</strong> : 현재 단계를 수행하거나 혹은 다음 단계로 진행 부탁드리겠습니다.<br> <strong>3rd 삭제</strong> : 더 이상 진행 계획이 없을 경우, 삭제를 해주시길 바랍니다.</br></br> <p>This 3rd has not been updated in the past six months. To ensure continuous management and efficient use of resources, please take one of the following actions:</p><br> <strong>3rd Update</strong> : Please proceed with the current phase or move on to the next stage.<br>  <strong>3rd Deletion</strong> : If there are no further plans to continue, please delete the 3rd.', 844, 'Y'),

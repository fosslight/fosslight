...
INSERT INTO `PROCESS_GUIDE` (`ID`, `PAGE_TARGET`, `CONTENTS`, `USE_YN`, `URL`) VALUES ('Project_List_BasicInfo_Security_Person', 'Project_List', '<div style="background:#eeeeee; border:1px solid #cccccc; padding:5px 10px">&bull; Creator, Editor와 함께 FOSSLight Hub에서 발송되는 Security 메일을 받으실 수 있습니다.<br />

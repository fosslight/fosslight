...
-- OSS_COMMON - OSS_VERSION VIEW TABLE
...
AS
  SELECT
    	...
    	OMV.OSS_VERSION,
    	OMC.HOMEPAGE,
		OMC.DOWNLOAD_LOCATION,
    	OMC.SUMMARY_DESCRIPTION,
    	OMV.LICENSE_DIV,
    	OMV.USE_YN,
    	OMV.VULN_CPE_NM,
    	OMV.CVSS_SCORE,
		...
		OMV.MODIFIED_DATE,
		OMV.RESTRICTION,
		OMC.IN_CPE_MATCH_FLAG
  FROM OSS_COMMON OMC
  LEFT JOIN OSS_VERSION OMV
  ON OMC.OSS_COMMON_ID = OMV.OSS_COMMON_ID
  ORDER BY OMC.OSS_COMMON_ID;

...
-- Already inserted in 20230818004358_update_v1.6.1.sql; Hompage_Link URL is updated here.
REPLACE INTO `PROCESS_GUIDE` (`ID`, `PAGE_TARGET`, `CONTENTS`, `URL`, `USE_YN`) VALUES ('Hompage_Link', 'Main', NULL, 'https://fosslight.org/hub-guide-en/', 'Y');
REPLACE INTO `PROCESS_GUIDE` (`ID`, `PAGE_TARGET`, `CONTENTS`, `URL`, `USE_YN`) VALUES ('Newsletter_Link', 'Main', NULL, 'https://fosslight.org/news/', 'Y');
REPLACE INTO `PROCESS_GUIDE` (`ID`, `PAGE_TARGET`, `CONTENTS`, `URL`, `USE_YN`) VALUES ('Support_Link', 'Main', NULL, 'https://github.com/fosslight/fosslight/issues', 'Y');
REPLACE INTO `PROCESS_GUIDE` (`ID`, `PAGE_TARGET`, `CONTENTS`, `URL`, `USE_YN`) VALUES ('Tips_Link', 'Main', NULL, 'https://www.youtube.com/@LGEOSPO', 'Y');

ALTER TABLE `PROJECT_MASTER` CHANGE `DESTRIBUTION_STATUS` `DISTRIBUTION_STATUS` VARCHAR(6);

DELETE FROM `T2_CODE_DTL` WHERE CD_NO = '913';

...
ALTER TABLE `NVD_CPE_MATCH` DROP PRIMARY KEY;
ALTER TABLE `NVD_CPE_MATCH` DROP COLUMN `SEQ`;
ALTER TABLE `NVD_CPE_MATCH` ADD `MATCH_CRITERIA_ID` varchar(128) NOT NULL;
ALTER TABLE `NVD_CPE_MATCH` ADD PRIMARY KEY (`MATCH_CRITERIA_ID`);
ALTER TABLE `NVD_CPE_MATCH_NAMES` DROP PRIMARY KEY;
ALTER TABLE `NVD_CPE_MATCH_NAMES` DROP COLUMN `SEQ`;
ALTER TABLE `NVD_CPE_MATCH_NAMES` ADD `MATCH_CRITERIA_ID` varchar(128) NOT NULL;
ALTER TABLE `NVD_CPE_MATCH_NAMES` ADD PRIMARY KEY (`MATCH_CRITERIA_ID`, `IDX`);
ALTER TABLE `NVD_DATA_SECURITY` ADD `REFERENCE_ID` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `NVD_DATA_SECURITY` ADD PRIMARY KEY (`REFERENCE_ID`, `OSS_NAME`, `OSS_VERSION`, `CVE_ID`, `CVSS_SCORE`);
ALTER TABLE `NVD_DATA_SECURITY` ADD INDEX (`REFERENCE_ID`);
...
CREATE TABLE `NVD_DATA_SECURITY` (

	...
	<div>
		...
		<div id="Total" class="tabContent">
			<div class="projectContents">
				<div class="btnLayout">
					<span class="left">
						<input type="button" value="Bulk Edit" onclick="sec_com_fn.bulkEdit('total')" class="btnColor btnColor red idenEdit" />
					</span>
					<span class="right">
		...
		<div id="Fixed" class="tabContent">
			<div class="projectContents">
				<div class="btnLayout">
					<span class="left">
						<input type="button" value="Bulk Edit" onclick="sec_com_fn.bulkEdit('fixed')" class="btnColor btnColor red idenEdit" />
					</span>
					<span class="right">
		...
		<div id="NotFixed" class="tabContent">
			<div class="projectContents">
				<div class="btnLayout">
					<span class="left">
						<input type="button" value="Bulk Edit" onclick="sec_com_fn.bulkEdit('notFixed')" class="btnColor btnColor red idenEdit" />
					</span>
					<span class="right">
...
<form id="secBulkEditForm" method="POST" action="<c:url value="/project/secBulkEditPopup"/>" target="bulkEditViewSecurityPopup">

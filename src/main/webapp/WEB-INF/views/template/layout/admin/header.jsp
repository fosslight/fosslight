...
<div id="header">
	<div class="back">
		...
		<div class="userLogout">
			...
			<span class="configurationSpan"><a href="#<c:url value="/configuration/edit"/>" class="add-tab" title="default tab"><span><img src="${ctxPath}/images/settings.png" alt="FOSSLight Hub" width="14" height="14" /></span>&nbsp;&nbsp;${sessUserInfo.userName}</a></span>

$(document).ready(function () {
    ...
    if (getCookie("tutorial") != null) {
        ...
        let array_tooltip_data = [
            ...
            {
                title: "Upload Report",
                content: "OSS List가 쓰여진 Sample FOSSLight Report(https://fosslight.org/fosslight-guide/tutorial/result_files/sample_src.tar.gz)를 다운로드 후, Upload 합니다. 이때 Load 할 Sheet로 SRC Sheet를 선택합니다."
            },
        ...
        function handle_click_next() {
            ...
            if (elem_index === array_highlights.length - 2) {
                $("#button_next").css({
                    display: "none"
                })
            } else {

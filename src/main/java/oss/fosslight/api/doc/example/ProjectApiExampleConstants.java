...
public final class ProjectApiExampleConstants {
    ...
    public static final String PROJECT_SECURITY_JSON_SUCCESS_EXAMPLE =
            "{\n"
                    + "  \"securityStatus\": \"VULNERABLE\",\n"
                    + "  \"needToResolve\": [\n"
                    + "    {\n"
                    + "      \"gridId\": \"jqg_sec_5796_1\",\n"
                    + "      \"ossName\": \"web\",\n"
                    + "      \"ossVersion\": \"\",\n"
                    + "      \"cvssScore\": \"8.8\",\n"
                    + "      \"cveId\": \"\",\n"
                    + "      \"publDate\": \"\",\n"
                    + "      \"modiDate\": \"2026-06-17\",\n"
                    + "      \"vulnSummary\": \"A vulnerability was found in uTorrent.\",\n"
                    + "      \"activateFlag\": \"N\",\n"
                    + "      \"vulnerabilityLink\": \"https://osc-dev.lge.com/vulnerability/vulnpopup?ossName=web&ossVersion=\",\n"
                    + "      \"groupKeyId\": \"\",\n"
                    + "      \"vulnerabilityResolution\": \"Unresolved\",\n"
                    + "      \"source\": \"\",\n"
                    + "      \"cpeName\": \"\",\n"
                    + "      \"verStartEndRange\": \"\",\n"
                    + "      \"officialPatchLink\": \"\",\n"

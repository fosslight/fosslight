...
public class ApiProjectV2Controller extends CoTopComponent {
	...
	@GetMapping(value = {API.FOSSLIGHT_API_PROJECT_SEARCH})
...
//			paramMap.put("userRole", userInfo.getAuthority());
	...
	@GetMapping(value = {API.FOSSLIGHT_API_MODEL_SEARCH})
	...
	@GetMapping(value = {API.FOSSLIGHT_API_PROJECT_BOM_EXPORT})
	...
	@GetMapping(value = {API.FOSSLIGHT_API_PROJECT_BOM_COMPARE})
	...
	@PostMapping(value = {API.FOSSLIGHT_API_OSS_REPORT_SRC})
	...
	@PostMapping(value = {API.FOSSLIGHT_API_OSS_REPORT_BIN})
	...
	@PostMapping(value = {API.FOSSLIGHT_API_OSS_REPORT_ANDROID})
	...
	@PostMapping(value = {API.FOSSLIGHT_API_PACKAGE_UPLOAD})
	public CommonResult ossReportAndroid(
    		@RequestHeader String _token,
    		@ApiParam(value = "Project id", required = true) @RequestParam(required = true) String prjId,
	...
	@GetMapping(value = {API.FOSSLIGHT_API_PROJECT_ADD_WATCHER})

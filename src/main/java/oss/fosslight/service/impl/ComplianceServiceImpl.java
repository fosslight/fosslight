...
//import oss.fosslight.domain.ComplianceInfo;
...
//	
//	@Override
//	public Map<String, Object> getModelList(ComplianceInfo project) {
//		HashMap<String, Object> map = new HashMap<>();
//		List<ComplianceInfo> list = new ArrayList<>();
//		
//		try {
//			project.setModelFlag(CoConstDef.FLAG_NO);
//			List<ComplianceInfo> projectNameList = projectMapper.selectModelInfoList(project);
//			
...
//			List<ComplianceInfo> modelNameList = projectMapper.selectModelInfoList(project);
//			
...
//				
//				if (duplicateCnt == 0) {
//					ComplianceInfo prj = new ComplianceInfo();
...
//			
//			if (list != null) {
//				final Comparator<ComplianceInfo> comp = Comparator.comparing((ComplianceInfo p) -> p.getModelName());
//				list = list.stream().sorted(comp).collect(Collectors.toList());
//				
//				// 코드변환처리
//				for (ComplianceInfo bean : list) {
//					// DISTRIBUTION_TYPE

...
public interface T2UserMapper {
	...
	public List<T2Users> selectAllUsersBasic();
	...
	public int updateUserDivisionByUserId(@Param("userId") String userId, @Param("division") String division, @Param("modifier") String modifier);
